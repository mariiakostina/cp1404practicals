...
def make_sentence(phrase):
    """
    Ensure sentence starts capital and ends period.
...
def run_tests():
    ...
    assert car_with_default_fuel.fuel == 0, "Fuel must be 0 by default"

    car_with_custom_fuel = Car(fuel=10)
    assert car_with_custom_fuel.fuel == 10, "Fuel not set correctly"
